-- =====================================================================
-- HiperStock: Script de Inicialización y Migración para Supabase / PostgreSQL
-- =====================================================================
...
-- Vista de compatibilidad para customers (sinónimo de clients)
CREATE OR REPLACE VIEW customers AS 
SELECT id, identification, name, address, phone, credit_limit, updated_at, deleted_at 
FROM clients;

-- 2. Tabla de Catálogo de Productos (products)
...
-- 3. Tabla de Pedidos / Órdenes (orders)
...
-- 4. Tabla de Detalle de Pedidos (order_items)
...
-- =====================================================================
-- SEED DE DATOS MAESTROS INICIALES
-- =====================================================================
